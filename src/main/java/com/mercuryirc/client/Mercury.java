...
public class Mercury extends Application {
	...
	public static void main(String[] args) {
		Font.loadFont(Mercury.class.getResource("/fonts/font_awesome.ttf").toExternalForm(), 12);
		Font.loadFont(Mercury.class.getResource("/fonts/open_sans.ttf").toExternalForm(), 12);
		Font.loadFont(Mercury.class.getResource("/fonts/inconsolata.ttf").toExternalForm(), 12);
		Font.loadFont(Mercury.class.getResource("/fonts/inconsolata_bold.ttf").toExternalForm(), 12);
		Settings.init();
		Tray.init();
	...
	public void start(Stage stage) {
		...
		stage.getIcons().add(new Image(Mercury.class.getResource("/images/icon32.png").toExternalForm()));
		...
		scene.setFill(null);
		scene.getStylesheets().add(Mercury.class.getResource("/css/Mercury.css").toExternalForm());
		...
		stage.show();
        ScriptManager.getInstance().reloadScripts();
        loadConnections();
	}
